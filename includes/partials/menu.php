...
/*
|----------------------------------------------------------------
|   Menu Contact hide on scroll.
|----------------------------------------------------------------
*/
if($contact_hide_scroll){
    $hide_contact_class = 'hide-contact';
}
...
?>
    ...
    <style type="text/css">
        ...
        .menu-transparent .main-menu a, .menu-transparent .social-icons,  .menu-transparent .menu-top {
...
|-------------------------------------------------------------------------------------------------------------------------------------------------
*/
echo '<header id="header" class="container-fluid container-capped '.$hide_contact_class.' '.$transparent_class.'" style="background: '.$background_color.'; position: '.$menu_position.'; font-size: '.$font_size.'px;">';
/*
|----------------------------------------------------------------
