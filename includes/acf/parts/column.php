...
|-------------------------------------------------------------------------------------------------------------------------------------------------
*/
echo '<div id="block" class="container-fluid container-capped '.($even_col_height ? 'same-col-height' : '').'" style="margin: '.$margin.'; padding: '.$padding.'; '.set_background_style($background, $background_color, $background_image, $background_image_align, $background_image_size, $background_image_repeat).'">';
...
echo '</div>'; // Block Container closing tag
